...
const timestamp = (day, hour, minute = 0) => new Date(Date.UTC(2024, 0, day, hour, minute));
const usersData = [
...
const ensureListId = (boardId, title) => {
...
const comment = (id, cardId, userId, text, day, hour, minute = 0) => ({
    id,
    cardId,
    userId,
    text,
